...
class WorkDaysControllerTest < ActionController::TestCase
  ...
  test "should create work_day" do
    assert_difference('WorkDay.count') do
      post :create, work_day: { doctor_full_name: @work_day.doctor_full_name, duration: @work_day.duration, time: @work_day.time }
    end
  ...
  test "should update work_day" do
    put :update, id: @work_day, work_day: { doctor_full_name: @work_day.doctor_full_name, duration: @work_day.duration, time: @work_day.time }
    assert_redirected_to work_day_path(assigns(:work_day))
  end
